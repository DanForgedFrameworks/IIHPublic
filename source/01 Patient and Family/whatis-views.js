/* =========================================================
   IIHPT006 — view rendering + interaction
   ...
   (Shared renderer pattern, first used in IIHPT004.)
   ========================================================= */
(function () {
  'use strict';

  var TOPICS = window.WHATIS_TOPICS || [];
  var STORE_VIEW = 'whatis006.view';
  var STORE_TOPIC = 'whatis006.topic';
  ...
  var STORE_ACCESSED = 'whatis006.accessed';
  var accessed = {};
